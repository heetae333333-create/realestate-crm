...
function moveInText(x){return x.move_in_immediate?'즉시입주 가능':x.move_in_negotiable?'입주가능일 협의 가능':x.move_in_date?fmtDate(x.move_in_date):'-'}
